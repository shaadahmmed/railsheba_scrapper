...
from bookings import single_seat_booking
from seat import check_seat_availability
...
def scrapper():
    ...
    trip_id, trip_route_id, boarding_point_id, seat_layout = check_seat_availability(
        headers
    )
    ...
    ticket_ids = single_seat_booking(seat_layout, trip_route_id, headers)

    if len(ticket_ids) == 0:
        print("No seats available!")
        exit()
    seats_dict["ticket_ids"] = ticket_ids
